  ...
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        ...
        </div><?php if($this->session->userdata("whs_create") == true){ ?>
    ...
    <div class="modal modal-blur fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          <form action="<?= base_url("data/add_category") ?>" method="POST" enctype="multipart/form-data">
    ...
    $(document).ready(function(){
      var table = $('#mytable').DataTable({
        ...
        "ajax": {
          ...
          "url": "<?= base_url('data/load_category_dt') ?>",
          "dataType": "json",
          "type": "POST",
        },
        columns: [
      ...
      $("#modal-edit").on('show.bs.modal', function(e) {
        ...
        if(btn.data("mode") == "Edit"){
          ...
          $.ajax({
            url: "<?= base_url('data/load_category/') ?>"+btn.data("id"),
            cache: false,
            type: "GET",
            success: function(response) {

              $('input[name=id]').val(response.id_category);
      ...
      $(document).on('click', '.btn-delete', function(){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location = "<?= base_url("data/delete_category/") ?>"+id;
          }
        });
      });
