...
<head>
  ...
  <!-- CSS files -->
  <link href="<?= base_url("assets/") ?>css/tabler.min.css?16841060162" rel="stylesheet"/>
  ...
  <div class="page">
    ...
    <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
      <div class="container-fluid">
        ...
        <h2 class="navbar-brand navbar-brand-autodark mb-0 h3">
          <a href=".">
            <img src="<?= base_url("assets/static/") ?>logo.png" width="50" height="50" alt="" class="mb-0" style="object-fit: scale-down !important;">
          </a>
          SIPATENBMN
        </h2>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
          <ul class="navbar-nav pt-lg-3" style="padding-top: 0 !important">
            <?php if($this->session->userdata("whs_master_data") == true){ ?>
                ...
                <div class="dropdown-menu show">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item <?= $last_uri == "inventory_item" ? "active" : "" ?>" href="<?= base_url("data/inventory_item") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "category" ? "active" : "" ?>" href="<?= base_url("data/category") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "unit" ? "active" : "" ?>" href="<?= base_url("data/unit") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "user" ? "active" : "" ?>" href="<?= base_url("user") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "role" ? "active" : "" ?>" href="<?= base_url("user/role") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "location" ? "active" : "" ?>" href="<?= base_url("data/location") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "unit_kerja" ? "active" : "" ?>" href="<?= base_url("data/unit_kerja") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      <a class="dropdown-item <?= $last_uri == "logs" ? "active" : "" ?>" href="<?= base_url("data/logs") ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <?php } ?>
              <?php if($this->session->userdata("whs_bmn") == true){ ?>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle show" href="javascript:;" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                  ...
                  <div class="dropdown-menu show">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <?php if($this->session->userdata("whs_stock_summary") == true){ ?>
                          <a class="dropdown-item <?= $sec_last_uri == "bmn" && $last_uri == "stock_summary" ? "active" : "" ?>" href="<?= base_url("bmn/stock_summary") ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <?php } ?>
                        <?php if($this->session->userdata("whs_stock_in") == true){ ?>
                          <a class="dropdown-item <?= $sec_last_uri == "bmn" && $last_uri == "stock_in" ? "active" : "" ?>" href="<?= base_url("bmn/stock_in") ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <?php } ?>
                        <?php if($this->session->userdata("whs_stock_out") == true){ ?>
                          <a class="dropdown-item <?= $sec_last_uri == "bmn" && $last_uri == "stock_out" ? "active" : "" ?>" href="<?= base_url("bmn/stock_out") ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <?php } ?>
                        <?php if($this->session->userdata("whs_report") == true){ ?>
                          <a class="dropdown-item <?= $sec_last_uri == "bmn" && $last_uri == "report" ? "active" : "" ?>" href="<?= base_url("bmn/report") ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <?php } ?>
                <?php if($this->session->userdata("whs_atk") == true){ ?>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle show" href="javascript:;" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true" >
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div class="dropdown-menu show">
                      <div class="dropdown-menu-columns">
                        <div class="dropdown-menu-column">
                          <?php if($this->session->userdata("whs_stock_summary") == true){ ?>
                            <a class="dropdown-item <?= $sec_last_uri == "atk" && $last_uri == "stock_summary" ? "active" : "" ?>" href="<?= base_url("atk/stock_summary") ?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-report-analytics"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M9 17v-5" /><path d="M12 17v-1" /><path d="M15 17v-3" /></svg>
                              </span>
                              <span class="nav-link-title">
                          ...
                          <?php } ?>
                          <?php if($this->session->userdata("whs_stock_in") == true){ ?>
                            <a class="dropdown-item <?= $sec_last_uri == "atk" && $last_uri == "stock_in" ? "active" : "" ?>" href="<?= base_url("atk/stock_in") ?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-stack-push"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 10l-2 1l8 4l8 -4l-2 -1" /><path d="M4 15l8 4l8 -4" /><path d="M12 4v7" /><path d="M15 8l-3 3l-3 -3" /></svg>
                              </span>
                              <span class="nav-link-title">
                          ...
                          <?php } ?>
                          <?php if($this->session->userdata("whs_stock_out") == true){ ?>
                            <a class="dropdown-item <?= $sec_last_uri == "atk" && $last_uri == "stock_out" ? "active" : "" ?>" href="<?= base_url("atk/stock_out") ?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-stack-pop"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 9.5l-3 1.5l8 4l8 -4l-3 -1.5" /><path d="M4 15l8 4l8 -4" /><path d="M12 11v-7" /><path d="M9 7l3 -3l3 3" /></svg>
                              </span>
                              <span class="nav-link-title">
                          ...
                          <?php } ?>
                          <?php if($this->session->userdata("whs_report") == true){ ?>
                            <a class="dropdown-item <?= $sec_last_uri == "atk" && $last_uri == "report" ? "active" : "" ?>" href="<?= base_url("atk/report") ?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-report"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h5.697" /><path d="M18 14v4h4" /><path d="M18 11v-4a2 2 0 0 0 -2 -2h-2" /><path d="M8 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M18 18m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M8 11h4" /><path d="M8 15h3" /></svg>
                              </span>
                              <span class="nav-link-title">
                  ...
                  <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                    <ul class="list-inline list-inline-dots mb-0">
                      <li class="list-inline-item">
                        ...
                        <a href="." class="link-secondary">Kementerian Pariwisata dan Ekonomi Kreatif</a>.
                        All rights reserved.
                      </li>
                    </ul>
                  </div>
        ...
        <script type="text/javascript">
          $( document ).ready(function() {
            ...
            $("select,input,textarea").filter("[required]").each( function(i, v) {
              ...
              $(this).parent().prev(".form-label").addClass("required");
            });
            $('form').on('submit', function(e) {
              if(!$(this).hasClass("bast")){
