...
<body  class=" d-flex flex-column">
  <div class="page page-center bg-dark" style="background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?= base_url("assets/") ?>static/bg.avif'); background-repeat: no-repeat; background-size: cover;">
    <div class="container container-tight py-4">
      ...
      <form class="card card-md" action="<?= base_url("login/send_forgot") ?>" method="POST">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Forgot password</h2>
          <p class="text-muted mb-4">Enter your email address and your reset password request will be emailed to you.</p>
          <div class="mb-3">
