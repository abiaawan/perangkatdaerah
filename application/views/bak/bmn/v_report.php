...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#export-excel").on("click", function() {
      window.location = "<?= base_url("export/bmn_report/") ?>?start=" + $("#filterStartDate").val() + "&end=" + $("#filterEndDate").val() + "&category=" + $("#filterCategory").val() + "&unit=" + $("#filterUnit").val() + "&inventory=" + $("#filterInventory").val();
    });
    ...
    var table = $('#mytable').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?= base_url('bmn/load_report_dt') ?>",
        "dataType": "json",
        "type": "POST",
        data: function(d){
