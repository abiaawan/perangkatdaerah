                                ...
                                <div class="row border">
                                    <div class="col-md-8 p-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ans[<?= "{$v->id_soal}" ?>]" id="<?= "{$v->kode_soal}-{$v->no}a" ?>" value="a" <?= find_answer($jawaban, $v->id_soal, "a") ?> <?= $status_jawaban->status == "submit" ? "disabled" : "" ?>>
                                            <label class="form-check-label" for="<?= "{$v->kode_soal}-{$v->no}a" ?>">
                                                <?= "{$v->jawaban_a}" ?>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ans[<?= "{$v->id_soal}" ?>]" id="<?= "{$v->kode_soal}-{$v->no}b" ?>" value="b" <?= find_answer($jawaban, $v->id_soal, "b") ?> <?= $status_jawaban->status == "submit" ? "disabled" : "" ?>>
                                            <label class="form-check-label" for="<?= "{$v->kode_soal}-{$v->no}b" ?>">
                                                <?= "{$v->jawaban_b}" ?>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ans[<?= "{$v->id_soal}" ?>]" id="<?= "{$v->kode_soal}-{$v->no}c" ?>" value="c" <?= find_answer($jawaban, $v->id_soal, "c") ?> <?= $status_jawaban->status == "submit" ? "disabled" : "" ?>>
                                            <label class="form-check-label" for="<?= "{$v->kode_soal}-{$v->no}c" ?>">
                                                <?= "{$v->jawaban_c}" ?>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ans[<?= "{$v->id_soal}" ?>]" id="<?= "{$v->kode_soal}-{$v->no}d" ?>" value="d" <?= find_answer($jawaban, $v->id_soal, "d") ?> <?= $status_jawaban->status == "submit" ? "disabled" : "" ?>>
                                            <label class="form-check-label" for="<?= "{$v->kode_soal}-{$v->no}d" ?>">
                                                <?= "{$v->jawaban_d}" ?>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ans[<?= "{$v->id_soal}" ?>]" id="<?= "{$v->kode_soal}-{$v->no}e" ?>" value="e" <?= find_answer($jawaban, $v->id_soal, "e") ?> <?= $status_jawaban->status == "submit" ? "disabled" : "" ?>>
